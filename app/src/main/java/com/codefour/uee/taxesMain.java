...
public class taxesMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taxes_main);

        ListView lt = (ListView) findViewById(R.id.listview);
        generateListContent();
        lt.setAdapter(new taxesMain.MyListAdapter(this, R.layout.activity_item_list, data));
    }
    ...
    private class MyListAdapter extends ArrayAdapter<String> {
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            taxesMain.ViewHolder mainView = null;

            if(convertView == null){
                LayoutInflater inflater = LayoutInflater.from(getContext());
                convertView = inflater.inflate(layout, parent, false);
                taxesMain.ViewHolder view = new taxesMain.ViewHolder();
                ...
                mainView = (taxesMain.ViewHolder) convertView.getTag();
    ...
    public void launchAddTax(View view) {
